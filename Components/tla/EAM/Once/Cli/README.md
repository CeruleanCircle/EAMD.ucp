...
running command...
$ once (--version)
Cli/0.0.0 darwin-arm64 node-v19.1.0
$ once --help [COMMAND]
USAGE
  $ once COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/CeruleanCircle/OnceCli/blob/v0.0.0/dist/commands/hello/index.ts)_
